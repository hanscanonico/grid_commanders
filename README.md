...
five faction rows — is generated by `generators/sprites`,
a deterministic Python voxel pipeline living in this repository, where each sprite is a hand-authored model rendered with one projection, light,
