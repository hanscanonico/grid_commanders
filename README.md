...
overflow, the two ambient clips (which sheets, in what order, at what cadence
— `ambient` for the board, `ambient_figures` for the cut-ins' shadowless pair,
on the same beat because they are the same motion), the
