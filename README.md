...
Twenty-one ship, spread across four factions (six to the Meridian Coalition, five each to the Iron
Dominion, the Aurora Compact and the Verdant League). `data/commanders/` is the
