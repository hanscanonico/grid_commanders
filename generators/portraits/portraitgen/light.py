...
# The four bands a ramp offers; what a material spends is `palette.SKIN_SLOTS` /
# `HAIR_SLOTS` / `METAL_SLOTS`. Naming them is the palette discipline: a tone is
# chosen from a ramp, never mixed at the call.
