...
host `mini-pc-Default-string` · commit `09fbc560` · pass 19 · up 4.4h · written 2026-08-31 21:00:39
...
## arena-search-default — done (31.2h ago, 5.9h)
...
## arena-search-easy — done (19.6h ago, 11.6h)
...
## arena-search-hard — done (13.3h ago, 6.3h)
...
## campaign-difficulty — done (3.8h ago, 1m)
...
## balance-pool-crossfire — done (3.8h ago, 5s)
...
## balance-pool-first_steps — done (3.8h ago, 5s)
...
## balance-pool-riverline — done (3.8h ago, 6s)
...
## balance-pool-scrimmage — done (3.7h ago, 5s)
...
## balance-pool-timberline — done (3.7h ago, 5s)
