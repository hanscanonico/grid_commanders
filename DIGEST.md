...
host `mini-pc-Default-string` · commit `09fbc560` · pass 42 · up 9.2h · written 2026-09-01 01:47:40
...
## arena-search-default — done (36.0h ago, 5.9h)
...
## arena-search-easy — done (24.4h ago, 11.6h)
...
## arena-search-hard — done (18.1h ago, 6.3h)
...
## commander-balance — done (8.7h ago, 30m)
...
## campaign-difficulty — done (8.6h ago, 1m)
...
## legibility-ratchet — done (8.6h ago, 4m)
...
## balance-pool-crossfire — done (8.5h ago, 5s)
...
## balance-pool-riverline — done (8.5h ago, 6s)
...
## balance-pool-scrimmage — done (8.5h ago, 5s)

none:hard vs none:normal — red 88%, blue 12%, undecided 0% over 32
none:normal vs none:hard — red 91%, blue 9%, undecided 0% over 32

## replay-survey-scrimmage — done (8.5h ago, 5s)
