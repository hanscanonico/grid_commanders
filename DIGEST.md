...
host `mini-pc-Default-string` · commit `1adb54fd` · pass 5 · up 57m · written 2026-09-11 21:07:01
...
## arena-search-default — done (295.3h ago, 5.9h)
...
## arena-search-easy — done (283.7h ago, 11.6h)
...
## arena-search-hard — done (277.4h ago, 6.3h)
...
## commander-balance — done (27.0h ago, 30m)
...
## replay-survey-arsenal — done (54m ago, 15s)
...
## replay-survey-crossfire — done (54m ago, 10s)
...
## replay-survey-jet_stream — done (53m ago, 15s)
...
## balance-pool-timberline — done (52m ago, 16s)
