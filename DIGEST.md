...
host `mini-pc-Default-string` · commit `09fbc560` · pass 41 · up 9.0h · written 2026-09-01 01:35:07
...
## arena-search-default — done (35.8h ago, 5.9h)
...
## arena-search-easy — done (24.2h ago, 11.6h)
...
## arena-search-hard — done (17.9h ago, 6.3h)
...
## commander-balance — done (8.5h ago, 30m)
...
## campaign-difficulty — done (8.4h ago, 1m)
...
## legibility-ratchet — done (8.3h ago, 4m)
...
## balance-pool-crossfire — done (8.3h ago, 5s)
...
## balance-pool-riverline — done (8.3h ago, 6s)
...
## balance-pool-scrimmage — done (8.3h ago, 5s)

none:hard vs none:normal — red 88%, blue 12%, undecided 0% over 32
none:normal vs none:hard — red 91%, blue 9%, undecided 0% over 32

## replay-survey-scrimmage — done (8.3h ago, 5s)
