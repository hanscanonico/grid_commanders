...
host `mini-pc-Default-string` · commit `f1131a3d` · pass 1562 · up 347.0h · written 2026-09-26 08:10:50
...
## arena-search-default — done (642.4h ago, 5.9h)
...
## arena-search-easy — done (630.8h ago, 11.6h)
...
## arena-search-hard — done (624.5h ago, 6.3h)
...
## difficulty-check — failed (1s ago, 6m)
...
## commander-balance — done (346.3h ago, 35m)
...
## campaign-difficulty — done (346.3h ago, 2m)

campaign-difficulty: 49 flagged (never won, a clock at or under the median win, or a blind seat neve
the_furnace_winter fw03_cold_relay                  normal  win 100%  fog   0%  day  3  deadline  0 
the_furnace_winter fw04_ice_road                    normal  win   0%  fog    —  day  0  deadline  0 
the_furnace_winter fw05_powder_ration               normal  win   0%  fog    —  day  0  deadline  0 
the_furnace_winter fw06_first_thaw                  normal  win   0%  fog    —  day  0  deadline  0 
the_furnace_winter fw07_pipeline_east               normal  win   0%  fog    —  day  0  deadline  0 
…
make[1] : on quitte le répertoire « /home/mini-pc/Documents/grid_commanders »

## legibility-ratchet — done (346.2h ago, 6m)
...
## balance-pool-riverline — done (346.1h ago, 11s)

none:hard vs none:normal — red 97%, blue 3%, undecided 0% over 32
none:normal vs none:hard — red 56%, blue 44%, undecided 0% over 32

## replay-survey-riverline — done (346.1h ago, 10s)
...
## balance-pool-scrimmage — done (346.1h ago, 10s)

none:hard vs none:normal — red 88%, blue 12%, undecided 0% over 32
none:normal vs none:hard — red 91%, blue 9%, undecided 0% over 32

## replay-survey-scrimmage — done (346.1h ago, 10s)
