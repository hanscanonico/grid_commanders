...
host `mini-pc-Default-string` · commit `eb10c427` · pass 1 · up 24.5h · written 2026-08-31 08:22:25

now: **nothing running** — idle, started —

queued this pass: —

## arena-search-default — done (18.6h ago, 5.9h)
...
## arena-search-easy — done (7.0h ago, 11.6h)
...
## arena-search-hard — done (41m ago, 6.3h)
...
## difficulty-check — failed (38m ago, 2m)
...
## commander-balance — done (8m ago, 30m)
...
## campaign-difficulty — done (6m ago, 1m)

campaign-difficulty: 50 flagged (never won, or a deadline at or under the median win)
...
## legibility-ratchet — done (2m ago, 4m)
...
## replay-survey-arsenal — done (1m ago, 10s)
...
## balance-pool-riverline — done (41s ago, 11s)

none:hard vs none:normal — red 97%, blue 3%, undecided 0% over 32
none:normal vs none:hard — red 56%, blue 44%, undecided 0% over 32

## replay-survey-riverline — done (31s ago, 10s)
...
## balance-pool-scrimmage — done (26s ago, 5s)

none:hard vs none:normal — red 88%, blue 12%, undecided 0% over 32
none:normal vs none:hard — red 91%, blue 9%, undecided 0% over 32

## replay-survey-scrimmage — done (21s ago, 5s)
