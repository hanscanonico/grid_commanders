...
host `mini-pc-Default-string` · commit `f1131a3d` · pass 1 · up 50m · written 2026-09-11 22:03:53

now: **nothing running** — idle, started —

queued this pass: —

## arena-search-default — done (296.3h ago, 5.9h)
...
## arena-search-easy — done (284.7h ago, 11.6h)
...
## arena-search-hard — done (278.4h ago, 6.3h)
...
## difficulty-check — failed (47m ago, 2m)
...
## commander-balance — done (12m ago, 35m)
...
## campaign-difficulty — done (9m ago, 2m)
...
## legibility-ratchet — done (2m ago, 6m)
...
## balance-pool-riverline — done (61s ago, 11s)

none:hard vs none:normal — red 97%, blue 3%, undecided 0% over 32
none:normal vs none:hard — red 56%, blue 44%, undecided 0% over 32

## replay-survey-riverline — done (51s ago, 10s)
...
## balance-pool-scrimmage — done (41s ago, 10s)

none:hard vs none:normal — red 88%, blue 12%, undecided 0% over 32
none:normal vs none:hard — red 91%, blue 9%, undecided 0% over 32

## replay-survey-scrimmage — done (31s ago, 10s)
