...
host `mini-pc-Default-string` · commit `eb10c427` · pass 25 · up 29.5h · written 2026-08-31 13:21:50
...
## arena-search-default — done (23.6h ago, 5.9h)
...
## arena-search-easy — done (12.0h ago, 11.6h)
...
## arena-search-hard — done (5.7h ago, 6.3h)
...
## commander-balance — done (5.1h ago, 30m)
...
## campaign-difficulty — done (5.1h ago, 1m)
...
## legibility-ratchet — done (5.0h ago, 4m)
...
## replay-survey-arsenal — done (5.0h ago, 10s)
...
## balance-pool-jet_stream — done (5.0h ago, 10s)
...
## balance-pool-scrimmage — done (5.0h ago, 5s)

none:hard vs none:normal — red 88%, blue 12%, undecided 0% over 32
none:normal vs none:hard — red 91%, blue 9%, undecided 0% over 32

## replay-survey-scrimmage — done (5.0h ago, 5s)
