...
host `mini-pc-Default-string` · commit `09fbc560` · pass 32 · up 7.1h · written 2026-08-31 23:42:55
...
## arena-search-default — done (33.9h ago, 5.9h)
...
## arena-search-easy — done (22.3h ago, 11.6h)
...
## arena-search-hard — done (16.0h ago, 6.3h)
...
## balance-pool-crossfire — done (6.5h ago, 5s)
...
## balance-pool-first_steps — done (6.5h ago, 5s)
...
## balance-pool-riverline — done (6.5h ago, 6s)
...
## replay-survey-scrimmage — done (6.4h ago, 5s)
...
## balance-pool-timberline — done (6.4h ago, 5s)
