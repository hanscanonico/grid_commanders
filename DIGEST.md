...
host `mini-pc-Default-string` · commit `eb10c427` · pass 40 · up 32.6h · written 2026-08-31 16:28:55
...
## arena-search-default — done (26.7h ago, 5.9h)
...
## arena-search-easy — done (15.1h ago, 11.6h)
...
## arena-search-hard — done (8.8h ago, 6.3h)
...
## commander-balance — done (8.3h ago, 30m)
...
## campaign-difficulty — done (8.2h ago, 1m)
...
## legibility-ratchet — done (8.1h ago, 4m)
...
## replay-survey-arsenal — done (8.1h ago, 10s)
...
## balance-pool-jet_stream — done (8.1h ago, 10s)
...
## balance-pool-scrimmage — done (8.1h ago, 5s)

none:hard vs none:normal — red 88%, blue 12%, undecided 0% over 32
none:normal vs none:hard — red 91%, blue 9%, undecided 0% over 32

## replay-survey-scrimmage — done (8.1h ago, 5s)
