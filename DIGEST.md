...
host `mini-pc-Default-string` · commit `eb10c427` · pass 39 · up 32.4h · written 2026-08-31 16:16:27
...
## arena-search-default — done (26.5h ago, 5.9h)
...
## arena-search-easy — done (14.9h ago, 11.6h)
...
## arena-search-hard — done (8.6h ago, 6.3h)
...
## commander-balance — done (8.0h ago, 30m)
...
## campaign-difficulty — done (8.0h ago, 1m)
...
## legibility-ratchet — done (7.9h ago, 4m)
...
## replay-survey-arsenal — done (7.9h ago, 10s)
...
## balance-pool-jet_stream — done (7.9h ago, 10s)
...
## balance-pool-scrimmage — done (7.9h ago, 5s)

none:hard vs none:normal — red 88%, blue 12%, undecided 0% over 32
none:normal vs none:hard — red 91%, blue 9%, undecided 0% over 32

## replay-survey-scrimmage — done (7.9h ago, 5s)
