...
host `mini-pc-Default-string` · commit `09fbc560` · pass 14 · up 3.4h · written 2026-08-31 19:58:20
...
## arena-search-default — done (30.2h ago, 5.9h)
...
## arena-search-easy — done (18.6h ago, 11.6h)
...
## arena-search-hard — done (12.3h ago, 6.3h)
...
## balance-pool-crossfire — done (2.7h ago, 5s)
...
## balance-pool-first_steps — done (2.7h ago, 5s)
...
## balance-pool-riverline — done (2.7h ago, 6s)
...
## balance-pool-timberline — done (2.7h ago, 5s)
