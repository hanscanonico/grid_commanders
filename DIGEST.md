...
host `mini-pc-Default-string` · commit `09fbc560` · pass 20 · up 4.6h · written 2026-08-31 21:13:07
...
## arena-search-default — done (31.4h ago, 5.9h)
...
## arena-search-easy — done (19.8h ago, 11.6h)
...
## arena-search-hard — done (13.5h ago, 6.3h)
...
## balance-pool-crossfire — done (4.0h ago, 5s)
...
## balance-pool-first_steps — done (4.0h ago, 5s)
...
## balance-pool-riverline — done (4.0h ago, 6s)
