...
host `mini-pc-Default-string` · commit `eb10c427` · pass 29 · up 30.3h · written 2026-08-31 14:11:40
...
## arena-search-default — done (24.4h ago, 5.9h)
...
## arena-search-easy — done (12.8h ago, 11.6h)
...
## arena-search-hard — done (6.5h ago, 6.3h)
...
## commander-balance — done (6.0h ago, 30m)
...
## campaign-difficulty — done (5.9h ago, 1m)
...
## legibility-ratchet — done (5.9h ago, 4m)
...
## balance-pool-crossfire — done (5.9h ago, 10s)
...
## balance-pool-jet_stream — done (5.8h ago, 10s)
...
## balance-pool-scrimmage — done (5.8h ago, 5s)

none:hard vs none:normal — red 88%, blue 12%, undecided 0% over 32
none:normal vs none:hard — red 91%, blue 9%, undecided 0% over 32

## replay-survey-scrimmage — done (5.8h ago, 5s)
