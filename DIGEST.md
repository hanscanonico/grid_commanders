...
host `mini-pc-Default-string` · commit `09fbc560` · pass 40 · up 8.8h · written 2026-09-01 01:22:37
...
## arena-search-default — done (35.6h ago, 5.9h)
...
## arena-search-easy — done (24.0h ago, 11.6h)
...
## arena-search-hard — done (17.7h ago, 6.3h)
...
## commander-balance — done (8.2h ago, 30m)
...
## balance-pool-crossfire — done (8.1h ago, 5s)
...
## balance-pool-first_steps — done (8.1h ago, 5s)
...
## balance-pool-riverline — done (8.1h ago, 6s)
...
## balance-pool-timberline — done (8.1h ago, 5s)
