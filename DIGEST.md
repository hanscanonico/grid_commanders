...
host `mini-pc-Default-string` · commit `09fbc560` · pass 4 · up 78m · written 2026-08-31 17:53:43
...
## arena-search-default — done (28.1h ago, 5.9h)
...
## arena-search-easy — done (16.5h ago, 11.6h)
...
## arena-search-hard — done (10.2h ago, 6.3h)
...
## commander-balance — done (45m ago, 30m)
...
## campaign-difficulty — done (43m ago, 1m)
...
## balance-pool-first_steps — done (38m ago, 5s)
...
## balance-pool-riverline — done (38m ago, 6s)

none:hard vs none:normal — red 97%, blue 3%, undecided 0% over 32
none:normal vs none:hard — red 56%, blue 44%, undecided 0% over 32

## replay-survey-riverline — done (37m ago, 10s)
...
## balance-pool-timberline — done (37m ago, 5s)
