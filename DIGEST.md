...
host `mini-pc-Default-string` · commit `eb10c427` · pass 2 · up 24.7h · written 2026-08-31 08:34:59
...
## arena-search-default — done (18.8h ago, 5.9h)
...
## arena-search-easy — done (7.2h ago, 11.6h)
...
## arena-search-hard — done (53m ago, 6.3h)
...
## commander-balance — done (21m ago, 30m)
...
## campaign-difficulty — done (19m ago, 1m)
...
## legibility-ratchet — done (14m ago, 4m)
...
## balance-pool-scrimmage — done (13m ago, 5s)

none:hard vs none:normal — red 88%, blue 12%, undecided 0% over 32
none:normal vs none:hard — red 91%, blue 9%, undecided 0% over 32

## replay-survey-scrimmage — done (12m ago, 5s)
