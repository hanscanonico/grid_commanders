...
host `mini-pc-Default-string` · commit `09fbc560` · pass 13 · up 3.2h · written 2026-08-31 19:45:52
...
## arena-search-default — done (30.0h ago, 5.9h)
...
## arena-search-easy — done (18.4h ago, 11.6h)
...
## arena-search-hard — done (12.1h ago, 6.3h)
...
## balance-pool-crossfire — done (2.5h ago, 5s)
...
## balance-pool-first_steps — done (2.5h ago, 5s)
...
## balance-pool-riverline — done (2.5h ago, 6s)
...
## balance-pool-timberline — done (2.5h ago, 5s)
