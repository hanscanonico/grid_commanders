...
host `mini-pc-Default-string` · commit `09fbc560` · pass 2 · up 53m · written 2026-08-31 17:28:42
...
## arena-search-default — done (27.7h ago, 5.9h)
...
## arena-search-easy — done (16.1h ago, 11.6h)
...
## arena-search-hard — done (9.8h ago, 6.3h)
...
## commander-balance — done (20m ago, 30m)
...
## campaign-difficulty — done (18m ago, 1m)
...
## balance-pool-first_steps — done (13m ago, 5s)
...
## balance-pool-riverline — done (13m ago, 6s)

none:hard vs none:normal — red 97%, blue 3%, undecided 0% over 32
none:normal vs none:hard — red 56%, blue 44%, undecided 0% over 32

## replay-survey-riverline — done (12m ago, 10s)
...
## balance-pool-scrimmage — done (12m ago, 5s)
...
## balance-pool-timberline — done (12m ago, 5s)
