...
host `mini-pc-Default-string` · commit `eb10c427` · pass 4 · up 25.1h · written 2026-08-31 08:59:55
...
## arena-search-default — done (19.2h ago, 5.9h)
...
## arena-search-easy — done (7.6h ago, 11.6h)
...
## arena-search-hard — done (78m ago, 6.3h)
...
## commander-balance — done (46m ago, 30m)
...
## campaign-difficulty — done (44m ago, 1m)
...
## legibility-ratchet — done (39m ago, 4m)
...
## balance-pool-riverline — done (38m ago, 11s)

none:hard vs none:normal — red 97%, blue 3%, undecided 0% over 32
none:normal vs none:hard — red 56%, blue 44%, undecided 0% over 32

## replay-survey-riverline — done (38m ago, 10s)
...
## balance-pool-scrimmage — done (37m ago, 5s)

none:hard vs none:normal — red 88%, blue 12%, undecided 0% over 32
none:normal vs none:hard — red 91%, blue 9%, undecided 0% over 32

## replay-survey-scrimmage — done (37m ago, 5s)
