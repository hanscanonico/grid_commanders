...
```sh
make commander-balance                 # full batch — a release task, 8,820 matches
...
- **Full batch:** 21×21 ordered pairs (mirrors included) × 5 scenarios × 4 seeds
  = **8,820 matches**. Ordered pairs already side-swap every non-mirror matchup.
