...
```sh
make commander-balance                 # full batch — a release task, 8,000 matches
...
- **Full batch:** 20×20 ordered pairs (mirrors included) × 5 scenarios × 4 seeds
  = **8,000 matches**. Ordered pairs already side-swap every non-mirror matchup.
